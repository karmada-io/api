...
func (c *FakeClusterResourceBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterResourceBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterResourceBindings) List(opts v1.ListOptions) (result *v1alpha1.ClusterResourceBindingList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ClusterResourceBindingList{}
...
func (c *FakeClusterResourceBindings) Create(clusterResourceBinding *v1alpha1.ClusterResourceBinding) (result *v1alpha1.ClusterResourceBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterResourceBindings) Update(clusterResourceBinding *v1alpha1.ClusterResourceBinding) (result *v1alpha1.ClusterResourceBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterResourceBindings) UpdateStatus(clusterResourceBinding *v1alpha1.ClusterResourceBinding) (*v1alpha1.ClusterResourceBinding, error) {
	obj, err := c.Fake.
...
func (c *FakeClusterResourceBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterResourceBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clusterresourcebindingsResource, name, data, subresources...), &v1alpha1.ClusterResourceBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterResourceBinding), err
