...
func (c *FakeResourceBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ResourceBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) List(opts v1.ListOptions) (result *v1alpha1.ResourceBindingList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ResourceBindingList{}
...
func (c *FakeResourceBindings) Create(resourceBinding *v1alpha1.ResourceBinding) (result *v1alpha1.ResourceBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) Update(resourceBinding *v1alpha1.ResourceBinding) (result *v1alpha1.ResourceBinding, err error) {
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) UpdateStatus(resourceBinding *v1alpha1.ResourceBinding) (*v1alpha1.ResourceBinding, error) {
	obj, err := c.Fake.
...
func (c *FakeResourceBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ResourceBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(resourcebindingsResource, c.ns, name, data, subresources...), &v1alpha1.ResourceBinding{})
