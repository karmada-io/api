...
type ClusterResourceBindingInterface interface {
	Create(*v1alpha1.ClusterResourceBinding) (*v1alpha1.ClusterResourceBinding, error)
	Update(*v1alpha1.ClusterResourceBinding) (*v1alpha1.ClusterResourceBinding, error)
	UpdateStatus(*v1alpha1.ClusterResourceBinding) (*v1alpha1.ClusterResourceBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ClusterResourceBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.ClusterResourceBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterResourceBinding, err error)
...
func (c *clusterResourceBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterResourceBinding, err error) {
...
func (c *clusterResourceBindings) List(opts v1.ListOptions) (result *v1alpha1.ClusterResourceBindingList, err error) {
...
func (c *clusterResourceBindings) Create(clusterResourceBinding *v1alpha1.ClusterResourceBinding) (result *v1alpha1.ClusterResourceBinding, err error) {
	result = &v1alpha1.ClusterResourceBinding{}
	err = c.client.Post().
		Resource("clusterresourcebindings").
...
func (c *clusterResourceBindings) Update(clusterResourceBinding *v1alpha1.ClusterResourceBinding) (result *v1alpha1.ClusterResourceBinding, err error) {
	result = &v1alpha1.ClusterResourceBinding{}
	err = c.client.Put().
		Resource("clusterresourcebindings").
...
func (c *clusterResourceBindings) UpdateStatus(clusterResourceBinding *v1alpha1.ClusterResourceBinding) (result *v1alpha1.ClusterResourceBinding, err error) {
	result = &v1alpha1.ClusterResourceBinding{}
	err = c.client.Put().
		Resource("clusterresourcebindings").
		Name(clusterResourceBinding.Name).
...
func (c *clusterResourceBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterResourceBinding, err error) {
	result = &v1alpha1.ClusterResourceBinding{}
