...
type ResourceBindingInterface interface {
	Create(*v1alpha1.ResourceBinding) (*v1alpha1.ResourceBinding, error)
	Update(*v1alpha1.ResourceBinding) (*v1alpha1.ResourceBinding, error)
	UpdateStatus(*v1alpha1.ResourceBinding) (*v1alpha1.ResourceBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ResourceBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.ResourceBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ResourceBinding, err error)
...
func (c *resourceBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ResourceBinding, err error) {
...
func (c *resourceBindings) List(opts v1.ListOptions) (result *v1alpha1.ResourceBindingList, err error) {
...
func (c *resourceBindings) Create(resourceBinding *v1alpha1.ResourceBinding) (result *v1alpha1.ResourceBinding, err error) {
	result = &v1alpha1.ResourceBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcebindings").
...
func (c *resourceBindings) Update(resourceBinding *v1alpha1.ResourceBinding) (result *v1alpha1.ResourceBinding, err error) {
	result = &v1alpha1.ResourceBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcebindings").
...
func (c *resourceBindings) UpdateStatus(resourceBinding *v1alpha1.ResourceBinding) (result *v1alpha1.ResourceBinding, err error) {
	result = &v1alpha1.ResourceBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcebindings").
...
func (c *resourceBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ResourceBinding, err error) {
	result = &v1alpha1.ResourceBinding{}
