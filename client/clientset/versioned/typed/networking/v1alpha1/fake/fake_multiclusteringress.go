...
func (c *FakeMultiClusterIngresses) Get(name string, options v1.GetOptions) (result *v1alpha1.MultiClusterIngress, err error) {
	obj, err := c.Fake.
...
func (c *FakeMultiClusterIngresses) List(opts v1.ListOptions) (result *v1alpha1.MultiClusterIngressList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.MultiClusterIngressList{}
...
func (c *FakeMultiClusterIngresses) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeMultiClusterIngresses) Create(multiClusterIngress *v1alpha1.MultiClusterIngress) (result *v1alpha1.MultiClusterIngress, err error) {
	obj, err := c.Fake.
...
func (c *FakeMultiClusterIngresses) Update(multiClusterIngress *v1alpha1.MultiClusterIngress) (result *v1alpha1.MultiClusterIngress, err error) {
	obj, err := c.Fake.
...
func (c *FakeMultiClusterIngresses) UpdateStatus(multiClusterIngress *v1alpha1.MultiClusterIngress) (*v1alpha1.MultiClusterIngress, error) {
	obj, err := c.Fake.
...
func (c *FakeMultiClusterIngresses) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeMultiClusterIngresses) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(multiclusteringressesResource, c.ns, listOptions)
...
func (c *FakeMultiClusterIngresses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MultiClusterIngress, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(multiclusteringressesResource, c.ns, name, data, subresources...), &v1alpha1.MultiClusterIngress{})
