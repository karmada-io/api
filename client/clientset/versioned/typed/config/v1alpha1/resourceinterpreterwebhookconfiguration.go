...
type ResourceInterpreterWebhookConfigurationInterface interface {
	Create(*v1alpha1.ResourceInterpreterWebhookConfiguration) (*v1alpha1.ResourceInterpreterWebhookConfiguration, error)
	Update(*v1alpha1.ResourceInterpreterWebhookConfiguration) (*v1alpha1.ResourceInterpreterWebhookConfiguration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ResourceInterpreterWebhookConfiguration, error)
	List(opts v1.ListOptions) (*v1alpha1.ResourceInterpreterWebhookConfigurationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ResourceInterpreterWebhookConfiguration, err error)
...
func (c *resourceInterpreterWebhookConfigurations) Get(name string, options v1.GetOptions) (result *v1alpha1.ResourceInterpreterWebhookConfiguration, err error) {
...
func (c *resourceInterpreterWebhookConfigurations) List(opts v1.ListOptions) (result *v1alpha1.ResourceInterpreterWebhookConfigurationList, err error) {
...
func (c *resourceInterpreterWebhookConfigurations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("resourceinterpreterwebhookconfigurations").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *resourceInterpreterWebhookConfigurations) Create(resourceInterpreterWebhookConfiguration *v1alpha1.ResourceInterpreterWebhookConfiguration) (result *v1alpha1.ResourceInterpreterWebhookConfiguration, err error) {
	result = &v1alpha1.ResourceInterpreterWebhookConfiguration{}
	err = c.client.Post().
		Resource("resourceinterpreterwebhookconfigurations").
...
func (c *resourceInterpreterWebhookConfigurations) Update(resourceInterpreterWebhookConfiguration *v1alpha1.ResourceInterpreterWebhookConfiguration) (result *v1alpha1.ResourceInterpreterWebhookConfiguration, err error) {
	result = &v1alpha1.ResourceInterpreterWebhookConfiguration{}
	err = c.client.Put().
		Resource("resourceinterpreterwebhookconfigurations").
...
func (c *resourceInterpreterWebhookConfigurations) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *resourceInterpreterWebhookConfigurations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	return c.client.Delete().
		Resource("resourceinterpreterwebhookconfigurations").
...
func (c *resourceInterpreterWebhookConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ResourceInterpreterWebhookConfiguration, err error) {
	result = &v1alpha1.ResourceInterpreterWebhookConfiguration{}
