...
import (
	...
	v1alpha1 "github.com/karmada-io/api/client/listers/config/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1alpha1().ResourceInterpreterWebhookConfigurations().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha1().ResourceInterpreterWebhookConfigurations().Watch(options)
			},
		},
		&config_v1alpha1.ResourceInterpreterWebhookConfiguration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceInterpreterWebhookConfigurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&config_v1alpha1.ResourceInterpreterWebhookConfiguration{}, f.defaultInformer)
}
