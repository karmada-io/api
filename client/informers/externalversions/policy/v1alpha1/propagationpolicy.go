	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().PropagationPolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().PropagationPolicies(namespace).Watch(options)
			},
		},
		&policy_v1alpha1.PropagationPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *propagationPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policy_v1alpha1.PropagationPolicy{}, f.defaultInformer)
}
