	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().ClusterOverridePolicies().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().ClusterOverridePolicies().Watch(options)
			},
		},
		&policy_v1alpha1.ClusterOverridePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterOverridePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policy_v1alpha1.ClusterOverridePolicy{}, f.defaultInformer)
}
