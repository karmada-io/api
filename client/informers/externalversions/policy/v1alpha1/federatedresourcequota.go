...
import (
	...
	v1alpha1 "github.com/karmada-io/api/client/listers/policy/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().FederatedResourceQuotas(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().FederatedResourceQuotas(namespace).Watch(options)
			},
		},
		&policy_v1alpha1.FederatedResourceQuota{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *federatedResourceQuotaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policy_v1alpha1.FederatedResourceQuota{}, f.defaultInformer)
}
