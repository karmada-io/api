	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkV1alpha2().ResourceBindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkV1alpha2().ResourceBindings(namespace).Watch(options)
			},
		},
		&work_v1alpha2.ResourceBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&work_v1alpha2.ResourceBinding{}, f.defaultInformer)
}
