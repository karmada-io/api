	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkV1alpha1().ClusterResourceBindings().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkV1alpha1().ClusterResourceBindings().Watch(options)
			},
		},
		&work_v1alpha1.ClusterResourceBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterResourceBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&work_v1alpha1.ClusterResourceBinding{}, f.defaultInformer)
}
