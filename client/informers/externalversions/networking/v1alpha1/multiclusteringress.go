...
import (
	...
	v1alpha1 "github.com/karmada-io/api/client/listers/networking/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha1().MultiClusterIngresses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha1().MultiClusterIngresses(namespace).Watch(options)
			},
		},
		&networking_v1alpha1.MultiClusterIngress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiClusterIngressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networking_v1alpha1.MultiClusterIngress{}, f.defaultInformer)
}
