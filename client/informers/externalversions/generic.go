...
import (
	...
	v1alpha1 "github.com/karmada-io/api/cluster/v1alpha1"
	config_v1alpha1 "github.com/karmada-io/api/config/v1alpha1"
	networking_v1alpha1 "github.com/karmada-io/api/networking/v1alpha1"
	policy_v1alpha1 "github.com/karmada-io/api/policy/v1alpha1"
...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case config_v1alpha1.SchemeGroupVersion.WithResource("resourceinterpreterwebhookconfigurations"):
	...
	case networking_v1alpha1.SchemeGroupVersion.WithResource("multiclusteringresses"):
	...
	case policy_v1alpha1.SchemeGroupVersion.WithResource("clusteroverridepolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Policy().V1alpha1().ClusterOverridePolicies().Informer()}, nil
	case policy_v1alpha1.SchemeGroupVersion.WithResource("clusterpropagationpolicies"):
